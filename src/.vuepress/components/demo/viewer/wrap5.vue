    ...
    >
      <div class="file-custom-item" slot-scope="{ record }">
        ...
        <div class="file-info-content">
          <h-auto-tooltip class="PB4" :text="record.fileName" />
          <div class="PB4 C-666">{{ record.time }}</div>
          <h-auto-tooltip class="PB4 C-666" :text="record.remark" />
        </div>
        <a-popconfirm
          title="确定要删除吗？"
          ok-text="确定"
          cancel-text="取消"
          @confirm="onFileDelete(record)"
        >
    ...
    return {
      fileList: [
        ...
        },
        {
          ...
          remark:
            "备注啊啊啊啊啊啊啊啊啊备注啊啊啊啊啊啊啊啊啊备注啊啊啊啊啊啊啊啊啊备注啊啊啊啊啊啊啊啊啊",
        },
      ],
    };
  },
