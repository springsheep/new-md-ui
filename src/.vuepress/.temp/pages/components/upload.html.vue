...
<p>基于 a-upload 封装的上传组件，支持使用 v-model、支持多种场景的文件上传、内置文件预览、支持文件夹上传、支持并发上传等场景。</p>
...
<p><strong>其他更多 API，请移步<a href="https://www.antdv.com/components/upload-cn/#API" target="_blank" rel="noopener noreferrer">传送门</a></strong></p>
</div></template>
