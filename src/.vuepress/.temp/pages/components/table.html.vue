...
<p>基于 a-table 封装的表格组件，增强了加载数据、数据交互提示、列拖动、拖拽排序功能，可以用更少的代码量实现更复杂的功能。</p>
...
## API
<p>其他更多 API，请移步<a href="https://www.antdv.com/components/table-cn/#API" target="_blank" rel="noopener noreferrer">传送门</a></p>
