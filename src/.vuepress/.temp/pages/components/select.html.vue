<template><div><h2 id="使用场景" tabindex="-1"><a class="header-anchor" href="#使用场景" aria-hidden="true">#</a> 使用场景</h2>
<p>基于 a-select 封装的下拉列表组件，当下拉的数据是通过接口获取时使用，将接口函数传递到 loadData 参数，可以减少一些代码量。其他场景还是建议使用 a-select。</p>
...
<p>其他更多 API，请移步<a href="https://www.antdv.com/components/select-cn/#API" target="_blank" rel="noopener noreferrer">传送门</a></p>
</div></template>
